...
if(isset($_POST['search']) && !empty($_POST['search'])){
    ...
    $sqlv = "SELECT * FROM users WHERE name = '$variable' OR email = '$variable' OR phone = '$variable'";
    $sresult = mysqli_query($conn, $sqlv);
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="upgrade.php" aria-controls="submenu-4"><i class="fab fa-fw fa-wpforms"></i>Upgrades</a>
                ...
                <div class="container-fluid dashboard-content ">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Admin Dashboard</li><br>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                <label for="validationCustom01">Search User</label>
                                                <input type="text" class="form-control" id="validationCustom01" placeholder="user name, email or phone" value="" name="variable" required>
                                                <div class="valid-feedback">
                                                
                                                </div>
                                            </div>
                                                 <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                <input type="submit" class="btn btn-primary" name="search"  value="Search"><span style="flex:5;"><pre>                         </pre></span>
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <?php foreach ($sresult as $user): ?>
                                                   <tr>
                                                        <?php if ($user['online'] == true) {
                                                           echo('<td><span class="badge-dot badge-success mr-1"></span>online </td>');
                                                        }else{
                                                            echo('<td><span class="badge-dot badge-brand mr-1"></span>offline </td>');
                                                        }?>
                            ...
                            <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Online Clients Lists</h5>
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead class="bg-light">
