    ...
    if (!empty($res)) {
        ...
        if(!empty($uid)){
            ...
            if (mysqli_query($conn, $sql)) {
                ...
                $fwit = $res['0']['totalwithdrawal'];
                
                $nwit = $fwit + $amount;
                $sql = "UPDATE users SET totalwithdrawal = $nwit  WHERE uid ='$uid'";
                if (mysqli_query($conn, $sql)) {
                    $txt = ' 
                                    <!DOCTYPE html>
                                    ...
                                    * {
                                    ...
                                    <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="font-size:30px;color:#2b303a;"><strong>Withdrawal Successful</strong></span></p>
                                    </div>
                                    </div>
                                    </td>
                                    </tr>
                                    ...
                                    <div style="font-family: sans-serif">
                                    <div class="" style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
                                    <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="color:#2b303a;font-size:18px;"><strong>your withdrawal of $ '.$amount.' has been processed and sent to your wallet address : '.$wallet.' successfully </strong></span></p>
                                    </div>
                                    </div>
                                    </td>
                                    </tr>
                ...
                sendmail($txt, $email, $name, "Withdrawal Successful");
...
if (isset($_POST['delete'])) {
    ...
    if (!empty($transaction)) {
        ...
        if (!empty($user)) {
            $email = $user['0']['email'];
            sendmail(
                apex_mail_message('Withdrawal Declined', 'Hi '.$name.",\n\nYour withdrawal request of $".$amount.' was declined. Please contact support for assistance.'),
                $email,
                $name,
                'Withdrawal Declined'
            );
