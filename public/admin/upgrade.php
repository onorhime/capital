...
if (!isset($_SESSION['admin'])) {
 ...
 $sql5 = "SELECT * FROM upgrade WHERE status='pending'";
 $upgrade = mysqli_query($conn, $sql5);
...
if (isset($_POST['approve'])) {
    ...
    if (!empty($res)) {
        ...
        if(!empty($uid)){
            $sql = "UPDATE upgrade SET status = 'approved' WHERE id = $id";
            if (mysqli_query($conn, $sql)) {
                ...
                $sql = "UPDATE users SET accounttype = 'level 2'  WHERE uid ='$uid'";
                if (mysqli_query($conn, $sql)) {
                    $txt = '
                            <!DOCTYPE html>
                            ...
                            <div align="center" class="alignment" style="line-height:10px"><img alt="I\'m an image" class="big" src="../account/php/images/Img4_2x.jpg" style="display: block; height: auto; border: 0; width: 352px; max-width: 100%;" title="I\'m an image" width="352"/></div>
                            </td>
                            </tr>
                            </table>
                            ...
                            <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="font-size:30px;color:#2b303a;"><strong>Your Account has been Upgraded successfully</strong></span></p>
                            </div>
                            </div>
                            </td>
                            </tr>
                            ...
                            <div style="font-family: sans-serif">
                            <div class="" style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
                            <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="color:#2b303a;font-size:18px;"><strong>Login to Account</strong></span></p>
                            </div>
                            </div>
                            </td>
                            </tr>
                            ...
                            <div style="font-family: sans-serif">
                            <div class="" style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
                            <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="color:#1aa19c;font-size:38px;"><span style=""><strong></strong></span></span></p>
                            </div>
                            </div>
                            </td>
                            </tr>
                ...
                sendmail($txt, $email, $name, "Account Upgrade Successful");
...
if (isset($_POST['delete'])) {
    ...
    $sql = "SELECT * FROM upgrade WHERE id = $id";
    $result = mysqli_query($conn, $sql);
    $upgrade = mysqli_fetch_all($result, MYSQLI_ASSOC);
    if (!empty($upgrade)) {
        $uid = $upgrade['0']['uid'];
        $name = $upgrade['0']['name'];
        $sql = "SELECT * FROM users WHERE uid = '$uid'";
        ...
        if (!empty($user)) {
            $email = $user['0']['email'];
            sendmail(
                apex_mail_message('Upgrade Declined', 'Hi '.$name.",\n\nYour account upgrade request was declined. Please contact support for assistance."),
                $email,
                $name,
                'Upgrade Declined'
            );
    ...
    $sql = "DELETE FROM upgrade WHERE id = $id";
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Upgrade Requests </h2>
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Upgrade Requests Lists</h5>
