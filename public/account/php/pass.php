...
$uid = $user['0']['uid'];
$sql = "INSERT INTO reset (email, uid) VALUES('$email', '$uid')";
if (mysqli_query($conn, $sql)) {
    $user = mysqli_fetch_all($result, MYSQLI_ASSOC);
    email($email, $uid);
    echo json_encode([
        'status' => 'success',
        'message' => 'Reset Link Has Been Sent Successful'
    ]) ;
}
}else{
    echo json_encode([
        'status' => 'error',
        'message' => 'Email Does Not Exist On This Server'
    ]) ;
}

function email($email, $uid){
        ...
        ini_set( 'display_errors', 1 );
                      ...
                      $txt = '
                                        ...
                                        <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="font-size:30px;color:#2b303a;"><strong>Reset your password with the password reset link below</strong></span></p>
                                        </div>
                                        </div>
                                        </td>
                                        </tr>
                                        ...
                                        <div style="font-family: sans-serif">
                                        <div class="" style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
                                        <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="color:#2b303a;font-size:18px;"><strong>Use this Reset Link</strong></span></p>
                                        </div>
                                        </div>
                                        </td>
                                        </tr>
                                        ...
                                        <div style="font-family: sans-serif">
                                        <div class="" style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
                                        <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="color:#1aa19c;font-size:38px;"><span style=""><strong><a href="../app-reset.html?id='.$uid.'">RESET PASSWORD</a></strong></span></span></p>
                                        </div>
                                        </div>
                                        </td>
                                        </tr>
