...
$sql = "SELECT * FROM reset WHERE uid = '$id'";

$result = mysqli_query($conn, $sql);
if(mysqli_num_rows($result)>0){
    $user = mysqli_fetch_all($result, MYSQLI_ASSOC);
    $email = $user['0']['email'];
    $sql = "UPDATE users SET password = '$pass' WHERE uid = '$id'";
    if (mysqli_query($conn, $sql)) {
    sendMail($email);
    $sql = "INSERT INTO notifications(amount, type, date, uid, message) VALUES('0.00','password','$date', '$id', 'Password was changed successfully')";
    if (mysqli_query($conn, $sql)) {
       $sql = "DELETE FROM reset WHERE uid = '$id'";
...
function sendMail($email){
    ...
    $headers .= 'From: ' . apex_mail_from_address() . "\r\n" .
    "CC: ";
    ...
    $txt = '
			...
			<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="font-size:30px;color:#2b303a;"><strong>Password was changed successfully, if you did not perform this action please contact support immdiately</strong></span></p>
			</div>
			</div>
			</td>
			</tr>
			...
			<div style="font-family: sans-serif">
			<div class="" style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
			<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="color:#2b303a;font-size:18px;"><strong>View Account</strong></span></p>
			</div>
			</div>
			</td>
			</tr>
			...
			<div style="font-family: sans-serif">
			<div class="" style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
			<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="color:#1aa19c;font-size:38px;"><span style=""><strong><a href="../app-login.html">My Account</a></strong></span></span></p>
			</div>
			</div>
			</td>
			</tr>
    ...
    sendmail($txt, $to, 'Apex Capital', $subject);
